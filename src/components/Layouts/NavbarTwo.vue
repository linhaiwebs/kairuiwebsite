<template>
  <nav
    :class="['navbar navbar-expand-lg bg-white ptb-21', { sticky: isSticky }]"
    id="navbar"
  >
    <div class="container mw-1740">
      <router-link class="navbar-brand me-95" to="/">
        <img
        ...
        <ul class="d-flex align-items-center">
          <li class="d-none d-xl-block">
            <form class="src-form position-relative z-1">
              ...
              <button
                type="submit"
                class="src-btn bg-transparent p-0 border-0 position-absolute top-50 end-0 translate-middle-y"
              >
          ...
          <li>
            <router-link to="/contact-us" class="default-btn btn-two">
              LET’S TALK
              <img
